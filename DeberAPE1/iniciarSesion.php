...
<nav class="rz-nav">
    <span class="brand">R.Z</span>
    <span class="nav-text">Pagina para Iniciar sesión</span>
</nav>

<div class="rz-content">
    <a href="portada.html" class="back-link">← Volver al inicio</a>

    <h1>Inicia <em>sesión</em></h1>
    <p class="subtitle">Bienvenido de nuevo. Con gusto te recibo.</p>
